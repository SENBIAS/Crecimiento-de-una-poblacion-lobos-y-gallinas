...
to Mundo
  ...
  create-tortugas 5
  create-tortugas1 5
  ask peces[set shape "fish" set size 3.5 set xcor random 33 set ycor random 33 set heading 90]
  ask peces1[set shape "fish 2" set size 3.5 set xcor random 33 set ycor random 33 set heading 90]
  ask peces2[set shape "fish 3" set size 3.5 set xcor random 33 set ycor random 33 set heading 90]
  ask plantas[set shape "plant" set size 2 set xcor random 33 set ycor random 33 set heading 90 set color green]
  ask flores[set shape "flower" set size 2 set xcor random 33 set ycor random 33 set color 67]
  ask flores1[set shape "flower budding" set size 2 set xcor random 33 set ycor random 33 set color 63]
  ask tortugas[set shape "turtle" set size 3.5 set xcor random 33 set ycor random -5 set heading 90]
  ask tortugas1[set shape "turtle 2" set size 3.5 set xcor random 33 set ycor random -5 set heading 90]
  Pintar
end
